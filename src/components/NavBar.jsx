    ...
    <nav className="w-full bg-white shadow rounded-b-xl px-2 sm:px-6 py-2 flex flex-row items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-3 w-full sm:w-auto justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-[#6d4bc1] hidden sm:inline">Causana</span>
        </div>
        {/* Menú */}
        <ul className="flex gap-2 sm:gap-4 ml-4">
          <li>
            <a href="/home" className="px-3 py-1 rounded-lg font-semibold text-[#6d4bc1] hover:bg-[#ede7f6] transition-colors">Inicio</a>
          </li>
          <li>
